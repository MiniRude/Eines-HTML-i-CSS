/*! lazysizes - v5.3.2 */ !function(e) {
    var t = function(u, D, f) {
        ...
        var O = D.documentElement, i = u.HTMLPictureElement, P = "addEventListener", $ = "getAttribute", q = u[P].bind(u), I = u.setTimeout, U = u.requestAnimationFrame || I, o = u.requestIdleCallback, j = /^picture$/i, r = [
            "load",
            "error",
            "lazyincluded",
            "_lazyloaded"
        ], a = {}, G = Array.prototype.forEach, J = function(e, t) {
            if (!a[t]) a[t] = new RegExp("(\\s|^)" + t + "(\\s|$)");
            ...
            return {
                _: function() {
                    ...
                    if (u.MutationObserver) new MutationObserver(a).observe(O, {
                        childList: true,
                        subtree: true,
                        attributes: true
                    });
...
//# sourceMappingURL=index.01926a3e.js.map
